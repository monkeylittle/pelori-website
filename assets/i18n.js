...
(function () {
  ...
  const T = {
    en: {
      ...
      'cta.sub': 'Pelori is in open beta on iOS via TestFlight. Join in with your crew — feedback shapes what ships next.',
      'cta.button': 'Join the TestFlight',
    ...
    nl: {
      ...
      'cta.sub': 'Pelori is in open bèta op iOS via TestFlight. Doe mee met je crew — jullie feedback bepaalt wat er volgt.',
      'cta.button': 'Doe mee aan de TestFlight',
    ...
    fr: {
      ...
      'cta.sub': 'Pelori est en bêta ouverte sur iOS via TestFlight. Rejoins-nous avec ta team — vos retours façonnent la suite.',
      'cta.button': 'Rejoindre TestFlight',
    ...
    es: {
      ...
      'cta.sub': 'Pelori está en beta abierta en iOS vía TestFlight. Únete con tu grupo — vuestros comentarios moldean lo que viene.',
      'cta.button': 'Unirse a TestFlight',
    ...
    it: {
      ...
      'cta.sub': 'Pelori è in beta aperta su iOS tramite TestFlight. Unisciti con la tua squadra — i vostri feedback plasmano i prossimi passi.',
      'cta.button': 'Entra in TestFlight',
