...
(function () {
  ...
  const T = {
    en: {
      ...
      'invite.title': 'Open this ride in Pelori',
      'invite.body': 'Tap the button below to open the invite in the Pelori app. If you don\'t have it yet, install Pelori first — the link will keep working.',
      'invite.open': 'Open in Pelori',
      'invite.get_ios': 'Get Pelori on iOS',
      'invite.get_android': 'Get Pelori on Android',
      'notfound.title': 'Page not found',
      'notfound.body': 'We couldn\'t find that page. The link may have been mistyped or moved.',
    ...
    nl: {
      ...
      'invite.title': 'Open deze rit in Pelori',
      'invite.body': 'Tik op de knop hieronder om de uitnodiging in de Pelori-app te openen. Heb je de app nog niet? Installeer Pelori eerst — de link blijft werken.',
      'invite.open': 'Openen in Pelori',
      'invite.get_ios': 'Download Pelori voor iOS',
      'invite.get_android': 'Download Pelori voor Android',
      'notfound.title': 'Pagina niet gevonden',
      'notfound.body': 'We konden die pagina niet vinden. Misschien is de link verkeerd getypt of verplaatst.',
    ...
    fr: {
      ...
      'invite.title': 'Ouvre cette sortie dans Pelori',
      'invite.body': 'Touche le bouton ci-dessous pour ouvrir l\'invitation dans l\'app Pelori. Si tu ne l\'as pas encore, installe Pelori d\'abord — le lien restera actif.',
      'invite.open': 'Ouvrir dans Pelori',
      'invite.get_ios': 'Télécharger Pelori sur iOS',
      'invite.get_android': 'Télécharger Pelori sur Android',
      'notfound.title': 'Page introuvable',
      'notfound.body': 'Nous n\'avons pas trouvé cette page. Le lien a peut-être été mal écrit ou déplacé.',
    ...
    es: {
      ...
      'invite.title': 'Abre esta ruta en Pelori',
      'invite.body': 'Toca el botón de abajo para abrir la invitación en la app Pelori. Si aún no la tienes, instala Pelori primero — el enlace seguirá funcionando.',
      'invite.open': 'Abrir en Pelori',
      'invite.get_ios': 'Consigue Pelori en iOS',
      'invite.get_android': 'Consigue Pelori en Android',
      'notfound.title': 'Página no encontrada',
      'notfound.body': 'No encontramos esa página. El enlace puede tener un error o haber cambiado.',
    ...
    it: {
      ...
      'invite.title': 'Apri questa uscita in Pelori',
      'invite.body': 'Tocca il pulsante qui sotto per aprire l\'invito nell\'app Pelori. Se non ce l\'hai ancora, installa prima Pelori — il link continuerà a funzionare.',
      'invite.open': 'Apri in Pelori',
      'invite.get_ios': 'Scarica Pelori per iOS',
      'invite.get_android': 'Scarica Pelori per Android',
      'notfound.title': 'Pagina non trovata',
      'notfound.body': 'Non abbiamo trovato quella pagina. Il link potrebbe essere stato scritto male o spostato.',
